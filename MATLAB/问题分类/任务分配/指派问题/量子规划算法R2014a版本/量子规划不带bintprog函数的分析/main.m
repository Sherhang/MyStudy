...
flag0=sum(Qmaxval1>=Qmaxval32);
per0=flag0/steps2


flag=sum(Qmaxval2==Qmaxval32);
per=flag/steps2

flag1=sum(Qmaxval2-Qmaxval32>=0);
per1=flag1/steps2

flag31=sum(Qmaxval31-Qmaxval32>=0);
per31=flag31/steps2
...
figure(1);
plot((Qmaxval1-Qmaxval32),'r')
hold on

plot(Qmaxval2-Qmaxval32,'g:.')
hold on
%legend('固定坍缩方案','模拟坍缩方案')
plot(EQmaxval1-Qmaxval32,'b:.')
hold on
%legend('固定坍缩方案','模拟坍缩方案','量子期望')

plot(Lmaxval-Qmaxval32,'k');
legend('固定坍缩方案','模拟坍缩方案','量子期望','线性规划取整')
...
legend('参考值','固定坍缩方案量子规划值','模拟坍缩方案量子规划值')
...
figure(4);
plot((Qmaxval31-Qmaxval32),'r')
hold on

plot(Qmaxval32-Qmaxval32,'g:.')
hold on
