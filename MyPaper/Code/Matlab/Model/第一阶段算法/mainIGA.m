...
t =  zeros(Repetition,1);
for i =1:Repetition
    [planGA_OX2_EM, fB(i,:),fM(i,:), t(i)] = IGA(obj,popsize,steps,Pcross,Pmutate, "OX2", "EM");
end
...
t =  zeros(Repetition,1);
for i =1:Repetition
    [planGA_OX2_EM, fB(i,:),fM(i,:), t(i)] = IGA(obj,popsize,steps,Pcross,Pmutate, "CX", "EM");
end
...
t =  zeros(Repetition,1);
for i =1:Repetition
    [planGA_PBX_EM, fB(i,:),fM(i,:), t(i)] = IGA(obj,popsize,steps,Pcross,Pmutate, "PBX", "EM");
end
...
for p=1:numCross
    for q=1:numMutate
        ...
        t =  zeros(Repetition,1);
        for i =1:Repetition
            [planGA_PMX_EM, fB(i,:),fM(i,:), t(i)] = IGA(obj,popsize,steps,Pcross,Pmutate, algoCross(p), algoMutate(q));
        end
        fB =  mean(fB);
