...
function [planSAGA, fBestSave,fMeanSave,XcrossSave,XmutateSave, time] = ACOVFSAGA(obj,popsize,steps,Pcross,Pmutate,Top,Dop)
% 输入obj，模型
...
for step=1:steps
   % 先保存一些重要的变量
    ...
    [sMutate,fitPop,Xmutate] = mutate(obj, sCross, fitPop, Pmutate,Xmutate);% 变异
